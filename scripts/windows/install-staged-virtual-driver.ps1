...
$unexpectedPublishedInfNames = if ($recordedPublishedInf) {
  @($beforePublishedInfNames | Where-Object { $_ -ine $recordedPublishedInf })
} else {
  @($beforePublishedInfNames)
}
