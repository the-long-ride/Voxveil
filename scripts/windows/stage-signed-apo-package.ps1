...
if ($destination -ieq $distRoot -or -not (Test-DirectoryContains $distRoot $destination)) {
  throw 'Signed APO staging destination must be below the repository dist\windows-x64 tree.'
}
