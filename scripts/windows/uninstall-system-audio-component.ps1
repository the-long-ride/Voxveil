...
if (Test-Path $statePath) {
  ...
  if ($developmentCertificateThumbprint -and $developmentCertificateThumbprint -notmatch '^[0-9A-Fa-f]{40}  $bootMarkerProperty = $state.PSObject.Properties['pendingRebootBootMarker']
